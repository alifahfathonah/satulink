...
?>
    ...
    <script src="<?php echo base_url('assets/assets/plugins/wizard/jquery.steps.min.js')?>"></script>
    <script src="<?php echo base_url('assets/assets/plugins/wizard/jquery.validate.min.js')?>"></script>
    <!-- Sweet-Alert  -->
    <script src="<?php echo base_url('assets/assets/plugins/sweetalert/sweetalert.min.js')?>"></script>
    <script src="<?php echo base_url('assets/assets/plugins/wizard/steps.js')?>"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!-- chartist chart -->
    ...
    <!-- Chart JS -->
    <script src="<?php echo base_url('assets/material/js/dashboard6.js')?>"></script>
    <!-- This is data table -->
    <script src="<?php echo base_url('assets/assets/plugins/datatables/jquery.dataTables.min.js')?>"></script>
    <!-- wysuhtml5 Plugin JavaScript -->
    <script src="<?php echo base_url('assets/assets/plugins/html5-editor/wysihtml5-0.3.0.js')?>"></script>
    <script src="<?php echo base_url('assets/assets/plugins/html5-editor/bootstrap-wysihtml5.js')?>"></script>
