		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor">Transaksi Agen</h3>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Agen</a></li>
						<li class="breadcrumb-item active">List Transaksi Agen</li>
					</ol>
				</div>
			</div>
			<!-- ============================================================== -->
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									<div class="card">
										<div class="card-body">
											<h4 class="card-title">Transaksi Agen</h4>
											<h6 class="card-subtitle">List Transaksi Agen</h6>
                        ...
                        <table id="tableData" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                              ...
                              <th>No.</th>
													...
													<?php
														$no=1;
														if(isset($data_transaksi_agen)){
															foreach($data_transaksi_agen as $row){
													?>
														<tr>
															<td><?php echo $no++; ?></td>
