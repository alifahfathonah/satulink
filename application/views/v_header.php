...
<head>
    ...
    <title>SatuLink Back Office</title>
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url('assets/assets/plugins/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url('assets/assets/plugins/html5-editor/bootstrap-wysihtml5.css')?>" />
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url('assets/assets/plugins/wizard/steps.css')?>" rel="stylesheet">
    <!--alerts CSS -->
    <link href="<?php echo base_url('assets/assets/plugins/sweetalert/sweetalert.css')?>" rel="stylesheet" type="text/css">
    <!-- Custom CSS -->
    ...
    <link href="<?php echo base_url('assets/material/css/colors/default.css')?>" id="theme" rel="stylesheet">
